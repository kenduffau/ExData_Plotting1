...
## Set and Plot 3. In this case the legend is truncated if the result is sent to the screen first.

png(filename = "plot3.png", width = 480, height = 480)

plot(pwrCons$DateTime, pwrCons$Sub_metering_1, type = "l", col = "black", xlab = "", ylab = "Energy sub metering")
